...
*--------------------------------------------------------------------
* Component: TextHandler.cs
*
* Description: This class provide functions to handle text.
*
...
*/
int TextHandler::CalSimilarPercent(System::String ^str1, System::String ^str2, bool ignoreCase, bool ignoreBlank)
{
...
int TextHandler::CalSimilarPercent(System::String ^str1, System::String ^str2)
{
