...
MemoryStore::MemoryStore(int processId, int transactionId, IntPtr notificationWindow) {
	m_paramKey.Format(_T("SHRINERAIN_AUTOTESTER_PARAMS.%d.%d"), processId, transactionId);
	m_retvalKey.Format(_T("SHRINERAIN_AUTOTESTER_RETVAL.%d.%d"), processId, transactionId);
