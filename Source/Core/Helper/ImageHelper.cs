...
namespace Shrinerain.AutoTester.Core
{
    public sealed class ImageHelper
    {
        ...
        private MemoryStream _tempImg;

        private Bitmap _sourceBitmap;
        private Bitmap _desBitmap;
        ...
        public static void SaveControlPrint(IntPtr handle, string fileName)
        {
            ...
            {
                throw new CannotSaveControlPrintException("Can not save control print: " + ex.Message);
            }
        }
        ...
        public static void SaveScreenArea(int left, int top, int width, int height, string fileName)
        {
            ...
            {
                throw new CannotSaveControlPrintException("Can not save screen area: " + ex.Message);
            }
        }
        ...
        public static void SaveScreenPrint(string fileName)
        {
            ...
            {
                throw new CannotSaveScreenPrintException("Can not save screen print file: " + fileName + "," + ex.Message);
            }
        }
        ...
        public static Image CaptureWindow(IntPtr handle)
        {
            try
            {
                ...
                {
                    throw new CannotSaveControlPrintException("Handle can not be 0.");
                }
        ...
        public static Image CaptureScreenArea(int left, int top, int width, int height)
        {
            try
            {
                if (width < 1 || height < 1)
                {
                    throw new CannotSaveControlPrintException("Width and Height must larger than 0.");
                }
            ...
            {
                throw new CannotSaveControlPrintException("Can not capture rect: " + ex.Message);
            }
        }
